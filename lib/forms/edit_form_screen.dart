...
class _EditFormScreenState extends State<EditFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Modifier le formulaire')),
      body: Padding(
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: 'Titre du formulaire'),
            ),
            ...
            ElevatedButton(onPressed: _addField, child: const Text('Ajouter un champ')),
            const SizedBox(height: 16),
            Expanded(
